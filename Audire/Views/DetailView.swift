...
final class InventoryDetailView: UIView {
    ...
    public let chargeButton = CustomButton(
        text: "Charge",
        fontStyle: "Bold",
        fontSize: 20,
        radius: 10
    ...
    public let sellButton = CustomButton(
        text: "Sell",
        fontStyle: "Bold",
        fontSize: 20,
        radius: 10
    ...
    public let equipButton = CustomButton(
        text: "Equip",
        fontStyle: "Bold",
        fontSize: 20,
        radius: 10
    ...
    private func makeConstarints() {
        ...
        headphoneCode.snp.makeConstraints { make in
            make.top.equalTo(headphoneNameLabel.snp.bottom).offset(34 * Resources.Multipliers.multiplierY)
