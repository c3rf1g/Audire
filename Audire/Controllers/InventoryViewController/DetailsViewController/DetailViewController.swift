...
final class InventoryDetailViewController: UIViewController {
    ...
    private let inventoryView = InventoryDetailView()
    ...
    private func addingTargets() {
        ...
        inventoryView.equipButton.addTarget(self, action: #selector(equipTapped), for: .touchUpInside)
    }
    ...
    @objc private func equipTapped() {
        ...
        let chartViewController = PlayerChartViewController()
